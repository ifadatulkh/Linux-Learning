...
- [Command Line](#command-line)
   - [Command Line and Sheel](#command-line-and-sheel)
   - [Sheel Command Structure](#sheel-command-structure)
   - [Basic Sheel Commands](#basic-sheel-commands)
...
- [**Bash Scripting**](#bash-scripting)
   ...
   - [Funtions](#funtions)
      ...
      - [Overriding commands](#overriding-commands)<!-- /TOC -->
